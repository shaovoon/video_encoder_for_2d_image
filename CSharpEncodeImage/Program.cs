...
namespace CSharpEncodeImage
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            H264Writer writer = new H264Writer(musicFile, videoFile, VideoCodec.H264, 640, 480, 30, 10000, frameRenderer, 40000000);
            if (writer.IsValid())
            {
                if (writer.Process())
                {
    ...
    */
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            H264Writer writer = new H264Writer(musicFile, videoFile, VideoCodec.H264, 640, 480, 30, 3000, frameRenderer, 40000000);
            if (writer.IsValid())
            {
                if (writer.Process())
                {
    ...
    */
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            H264Writer writer = new H264Writer(musicFile, videoFile, VideoCodec.H264, 640, 480, 60, 2000, frameRenderer, 40000000);
            if (writer.IsValid())
            {
                if (writer.Process())
                {
