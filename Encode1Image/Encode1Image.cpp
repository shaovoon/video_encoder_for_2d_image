...
int main()
{
	...
	H264Writer writer(musicFile.c_str(), videoFile.c_str(), VideoCodec::H264, Processing::HardwareAcceleration, 640, 480, 30, 10000, &frameRenderer, 4000000, 0, 100, RateControlMode::Quality, 100);
	if (writer.IsValid())
	{
		if (writer.Process())
		{
...
int main()
{
	...
	H264Writer writer(musicFile.c_str(), videoFile.c_str(), VideoCodec::H264, Processing::HardwareAcceleration, 640, 480, 30, 3000, &frameRenderer, 4000000, 0, 100, RateControlMode::Quality, 100);
	if (writer.IsValid())
	{
		if (writer.Process())
		{
...
int main()
{
	...
	H264Writer writer(musicFile.c_str(), videoFile.c_str(), VideoCodec::H264, Processing::HardwareAcceleration, 640, 480, 60, 2000, &frameRenderer, 4000000, 0, 100, RateControlMode::Quality, 100);
	if (writer.IsValid())
	{
		if (writer.Process())
		{
