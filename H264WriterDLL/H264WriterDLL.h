...
namespace H264WriterDLL {
	...
	public: UINT32 getEncCommonQuality() { return m_EncCommonQuality; }
	public: void setEncCommonQuality(UINT32 val) { m_EncCommonQuality = val; }
